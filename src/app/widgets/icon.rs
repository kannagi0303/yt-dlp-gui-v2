...
impl AppIcon {
    ...
    fn svg_bytes(self) -> &'static [u8] {
        match self {
            ...
            Self::SkipPrevious => include_bytes!("../../../assets/icons/SkipPrevious.svg"),
            Self::SkipNext => include_bytes!("../../../assets/icons/SkipNext.svg"),
            Self::ArrowRight => include_bytes!("../../../assets/icons/ArrowRight.svg"),
            Self::Repeat => include_bytes!("../../../assets/icons/Repeat.svg"),
            Self::RepeatOnce => include_bytes!("../../../assets/icons/RepeatOnce.svg"),
