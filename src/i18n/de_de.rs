pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "notification.download_finished" => "Download abgeschlossen",
        "notification.download_failed" => "Download fehlgeschlagen",
        "notification.download_finished_detail_prefix" => "Abgeschlossen: ",
        "notification.download_finished_detail" => "Download abgeschlossen.",
        "notification.windows_toast_windows_only" => {
            "Windows Toast wird nur unter Windows unterstützt."
        }
        "media.video" => "Video",
        "media.audio" => "Audio",
        ...
        "item.stop_download" => "Download stoppen",
        ...
        "prepare.required" => "Erforderlich",
        "prepare.recommended" => "Empfohlen",
        ...
        "config.youtube_playlist_mode.ask" => "Fragen",
        "config.youtube_playlist_mode.video" => "Video",
        "config.youtube_playlist_mode.ignore" => "Ignorieren",
        "config.output_action.menu" => "Menü anzeigen",
        "config.output_action.open_folder" => "Ordner öffnen",
        "config.output_action.open_file" => "Datei öffnen",
        "tools.file_time.none" => "Nicht ändern",
        "tools.file_time.use_upload_date" => "Video-Uploaddatum verwenden",
        "tools.file_time.use_download_time" => "Download-Zeit verwenden",
        "tools.file_time.none_hint" => {
            "Kein --mtime/--no-mtime übergeben und die endgültige Dateizeit nicht ändern."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Nachdem yt-dlp den endgültigen Dateipfad meldet, wird die Änderungszeit auf das Video-Uploaddatum gesetzt."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "Standard",
        "tools.subtitle_source.none" => "Keine Untertitel",
        "tools.subtitle_source.original" => "Originaluntertitel",
        "tools.subtitle_source.automatic" => "Automatische Untertitel",
        ...
        "domain.quality.best" => "Beste",
        "domain.quality.audio_only" => "Nur Audio",
        ...
        "thumbnail.filter.jpeg" => "JPEG-Bild",
        "thumbnail.filter.png" => "PNG-Bild",
        "thumbnail.filter.webp" => "WebP-Bild",
        "thumbnail.filter.original" => "Originalbild",
        ...
        "state.thumbnail_saved" => "Miniaturbild gespeichert: {path}",
