pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "notification.download_finished" => "Download completato",
        "notification.download_failed" => "Download non riuscito",
        "notification.download_finished_detail_prefix" => "Completato: ",
        "notification.download_finished_detail" => "Download completato.",
        "notification.windows_toast_windows_only" => "Windows Toast è supportato solo su Windows.",
        "media.video" => "Video",
        "media.audio" => "Audio",
        ...
        "item.stop_download" => "Ferma download",
        "item.remove" => "Rimuovi",
        ...
        "config.youtube_playlist_mode.ask" => "Chiedi",
        "config.youtube_playlist_mode.video" => "Video",
        "config.youtube_playlist_mode.ignore" => "Ignore",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Apri cartella",
        "config.output_action.open_file" => "Apri file",
        "tools.file_time.none" => "Non modificare",
        "tools.file_time.use_upload_date" => "Usa data di pubblicazione del video",
        "tools.file_time.use_download_time" => "Usa ora di download",
        "tools.file_time.none_hint" => {
            "Non passa --mtime/--no-mtime e non modifica l’orario del file finale."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Dopo che yt-dlp segnala il percorso finale, imposta l’orario di modifica sulla data di pubblicazione del video."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "Predefinito",
        "tools.subtitle_source.none" => "Nessun sottotitolo",
        ...
        "thumbnail.filter.jpeg" => "Immagine JPEG",
        "thumbnail.filter.png" => "Immagine PNG",
        "thumbnail.filter.webp" => "Immagine WebP",
        "thumbnail.filter.original" => "Immagine originale",
        ...
        "state.thumbnail_saved" => "Miniatura salvata: {path}",
