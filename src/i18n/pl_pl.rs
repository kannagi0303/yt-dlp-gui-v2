pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "notification.download_finished" => "Pobieranie zakończone",
        "notification.download_failed" => "Pobieranie nieudane",
        "notification.download_finished_detail_prefix" => "Zakończono: ",
        "notification.download_finished_detail" => "Pobieranie zakończone.",
        "notification.windows_toast_windows_only" => {
            "Windows Toast jest obsługiwany tylko w systemie Windows."
        }
        "media.video" => "Wideo",
        "media.audio" => "Audio",
        ...
        "item.stop_download" => "Zatrzymaj pobieranie",
        "item.remove" => "Usuń",
        ...
        "prepare.required" => "Wymagane",
        "prepare.recommended" => "Zalecane",
        ...
        "config.youtube_playlist_mode.ask" => "Pytaj",
        "config.youtube_playlist_mode.video" => "Wideo",
        "config.youtube_playlist_mode.ignore" => "Ignore",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Otwórz folder",
        "config.output_action.open_file" => "Otwórz plik",
        "tools.file_time.none" => "Nie zmieniaj",
        "tools.file_time.use_upload_date" => "Użyj daty publikacji filmu",
        "tools.file_time.use_download_time" => "Użyj czasu pobrania",
        "tools.file_time.none_hint" => {
            "Nie przekazuje --mtime/--no-mtime i nie zmienia czasu końcowego pliku."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Po zgłoszeniu końcowej ścieżki przez yt-dlp ustawia czas modyfikacji na datę publikacji filmu."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "Domyślne",
        ...
        "domain.quality.best" => "Najlepsze",
        "domain.quality.audio_only" => "Tylko audio",
        ...
        "thumbnail.filter.jpeg" => "Obraz JPEG",
        "thumbnail.filter.png" => "Obraz PNG",
        "thumbnail.filter.webp" => "Obraz WebP",
        "thumbnail.filter.original" => "Oryginalny obraz",
        ...
        "state.thumbnail_saved" => "Miniatura zapisana: {path}",
