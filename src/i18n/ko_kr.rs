pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "thumbnail.filter.jpeg" => "JPEG 이미지",
        "thumbnail.filter.png" => "PNG 이미지",
        "thumbnail.filter.webp" => "WebP 이미지",
        "thumbnail.filter.original" => "원본 이미지",
        ...
        "state.thumbnail_saved" => "썸네일 저장됨: {path}",
