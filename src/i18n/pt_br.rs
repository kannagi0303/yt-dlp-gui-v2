pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "notification.download_finished" => "Download concluído",
        "notification.download_failed" => "Falha no download",
        "notification.download_finished_detail_prefix" => "Concluído: ",
        "notification.download_finished_detail" => "Download concluído.",
        "notification.windows_toast_windows_only" => "Windows Toast só é compatível com Windows.",
        "media.video" => "Vídeo",
        "media.audio" => "Áudio",
        ...
        "item.stop_download" => "Parar download",
        "item.remove" => "Remover",
        ...
        "config.youtube_playlist_mode.ask" => "Perguntar",
        "config.youtube_playlist_mode.video" => "Vídeo",
        "config.youtube_playlist_mode.ignore" => "Ignore",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Abrir pasta",
        "config.output_action.open_file" => "Abrir arquivo",
        "tools.file_time.none" => "Não alterar",
        "tools.file_time.use_upload_date" => "Usar data de publicação do vídeo",
        "tools.file_time.use_download_time" => "Usar hora do download",
        "tools.file_time.none_hint" => {
            "Não passa --mtime/--no-mtime e não altera a hora do arquivo final."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Depois que o yt-dlp informar o caminho final, define a hora de modificação como a data de publicação do vídeo."
        }
