pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        "tab.prepare" => "Προετοιμασία",
        "tab.main" => "Κύρια",
        "tab.advanced" => "Για προχωρημένους",
        ...
        "notification.download_finished" => "Η λήψη ολοκληρώθηκε",
        "notification.download_failed" => "Η λήψη απέτυχε",
        "notification.download_finished_detail_prefix" => "Ολοκληρώθηκε: ",
        "notification.download_finished_detail" => "Η λήψη ολοκληρώθηκε.",
        "notification.windows_toast_windows_only" => {
            "Το Windows Toast υποστηρίζεται μόνο στα Windows."
        }
        "media.video" => "Βίντεο",
        "media.audio" => "Ήχος",
        ...
        "item.stop_download" => "Διακοπή λήψης",
        "item.remove" => "Αφαίρεση",
        ...
        "config.youtube_playlist_mode.ask" => "Ερώτηση",
        "config.youtube_playlist_mode.video" => "Βίντεο",
        "config.youtube_playlist_mode.ignore" => "Ignore",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Άνοιγμα φακέλου",
        "config.output_action.open_file" => "Άνοιγμα αρχείου",
        "tools.file_time.none" => "Να μην αλλάξει",
        "tools.file_time.use_upload_date" => "Χρήση ημερομηνίας δημοσίευσης βίντεο",
        "tools.file_time.use_download_time" => "Χρήση ώρας λήψης",
        "tools.file_time.none_hint" => {
            "Δεν περνά --mtime/--no-mtime και δεν αλλάζει τον χρόνο του τελικού αρχείου."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Αφού το yt-dlp αναφέρει την τελική διαδρομή, ορίζει τον χρόνο τροποποίησης στην ημερομηνία δημοσίευσης του βίντεο."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "Προεπιλογή",
        ...
        "domain.quality.best" => "Καλύτερο",
        "domain.quality.audio_only" => "Μόνο ήχος",
        ...
        "thumbnail.filter.jpeg" => "Εικόνα JPEG",
        "thumbnail.filter.png" => "Εικόνα PNG",
        "thumbnail.filter.webp" => "Εικόνα WebP",
        "thumbnail.filter.original" => "Αρχική εικόνα",
        ...
        "state.thumbnail_saved" => "Η μικρογραφία αποθηκεύτηκε: {path}",
