pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "notification.download_finished" => "Завантаження завершено",
        "notification.download_failed" => "Помилка завантаження",
        "notification.download_finished_detail_prefix" => "Завершено: ",
        "notification.download_finished_detail" => "Завантаження завершено.",
        "notification.windows_toast_windows_only" => "Windows Toast підтримується лише у Windows.",
        "media.video" => "Відео",
        "media.audio" => "Аудіо",
        ...
        "item.stop_download" => "Зупинити завантаження",
        "item.remove" => "Видалити",
        ...
        "config.youtube_playlist_mode.ask" => "Запитувати",
        "config.youtube_playlist_mode.video" => "Відео",
        "config.youtube_playlist_mode.ignore" => "Ignore",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Відкрити папку",
        "config.output_action.open_file" => "Відкрити файл",
        "tools.file_time.none" => "Не змінювати",
        "tools.file_time.use_upload_date" => "Використати дату публікації відео",
        "tools.file_time.use_download_time" => "Використати час завантаження",
        "tools.file_time.none_hint" => {
            "Не передає --mtime/--no-mtime і не змінює час кінцевого файлу."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Після повідомлення кінцевого шляху від yt-dlp встановлює час зміни файлу на дату публікації відео."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "За замовчуванням",
        ...
        "domain.quality.best" => "Найкраще",
        "domain.quality.audio_only" => "Лише аудіо",
        ...
        "thumbnail.filter.jpeg" => "Зображення JPEG",
        "thumbnail.filter.png" => "Зображення PNG",
        "thumbnail.filter.webp" => "Зображення WebP",
        "thumbnail.filter.original" => "Оригінальне зображення",
        ...
        "state.thumbnail_saved" => "Мініатюру збережено: {path}",
