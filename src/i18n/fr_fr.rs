pub fn text<'a>(key: &'a str) -> &'a str {
    match key {
        ...
        "item.thumbnail_preview" => "Aperçu miniature",
        "notification.download_finished" => "Téléchargement terminé",
        "notification.download_failed" => "Échec du téléchargement",
        "notification.download_finished_detail_prefix" => "Terminé : ",
        "notification.download_finished_detail" => "Téléchargement terminé.",
        "notification.windows_toast_windows_only" => {
            "Windows Toast est uniquement pris en charge sous Windows."
        }
        "media.video" => "Vidéo",
        "media.audio" => "Audio",
        ...
        "item.stop_download" => "Arrêter le téléchargement",
        ...
        "picker.subtitle_tab.none" => "Pas de sous-titres",
        "picker.subtitle_tab.original" => "Sous-titres originaux",
        "picker.subtitle_tab.automatic" => "Sous-titres automatiques",
        "config.youtube_playlist_mode.ask" => "Demander",
        "config.youtube_playlist_mode.video" => "Vidéo",
        "config.youtube_playlist_mode.ignore" => "Ignorer",
        "config.output_action.menu" => "Show menu",
        "config.output_action.open_folder" => "Ouvrir le dossier",
        "config.output_action.open_file" => "Ouvrir le fichier",
        "tools.file_time.none" => "Ne pas modifier",
        "tools.file_time.use_upload_date" => "Utiliser la date de publication",
        "tools.file_time.use_download_time" => "Utiliser l’heure de téléchargement",
        "tools.file_time.none_hint" => {
            "Ne passe pas --mtime/--no-mtime et ne modifie pas la date du fichier final."
        }
        "tools.file_time.use_upload_date_hint" => {
            "Après le chemin final signalé par yt-dlp, définit la date de modification sur la date de publication de la vidéo."
        }
        "tools.file_time.use_download_time_hint" => "--no-mtime",
        "tools.cache_mode.default" => "Par défaut",
        "tools.subtitle_source.none" => "Pas de sous-titres",
        "tools.subtitle_source.original" => "Sous-titres originaux",
        "tools.subtitle_source.automatic" => "Sous-titres automatiques",
        ...
        "domain.quality.best" => "Meilleur",
        "domain.quality.audio_only" => "Audio uniquement",
        ...
        "thumbnail.filter.jpeg" => "Image JPEG",
        "thumbnail.filter.png" => "Image PNG",
        "thumbnail.filter.webp" => "Image WebP",
        "thumbnail.filter.original" => "Image originale",
        ...
        "state.thumbnail_saved" => "Miniature enregistrée : {path}",
